...
from .views import DetallesCasaView, AnunciosView, Vista360View, MisPublicacionesView, NuevaPublicaion
...
urlpatterns = [
    ...
    path('nueva_publicacion/', NuevaPublicaion.as_view(), name='nueva_publicacion'),
]